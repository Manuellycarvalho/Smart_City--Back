# Generated by Django 4.2.13 on 2024-05-17 12:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_address', models.CharField(max_length=20, null=True)),
                ('latitude', models.FloatField()),
                ('longitude', models.FloatField()),
                ('localizacao', models.CharField(max_length=100)),
                ('responsavel', models.CharField(max_length=50)),
                ('umidade_medida', models.CharField(blank=True, max_length=20, null=True)),
